...
final Map<SymbolParts, String> symbol = {
  ...
  SymbolParts.angstrom: stringFromUnicode(unicodeAngstrom),
  SymbolParts.are: 'a',
  ...
  SymbolParts.britishThermalUnit: 'BTU',
  SymbolParts.bushel: 'bu',
  SymbolParts.byte: 'B',
  SymbolParts.calorie: 'cal',
  ...
  SymbolParts.mega: 'M',
  SymbolParts.metre: 'm',
  SymbolParts.mho: stringFromUnicode(unicodeMho),
  SymbolParts.micro: stringFromUnicode(unicodeMicro),
  SymbolParts.mile: 'mi',
  ...
  SymbolParts.ohm: stringFromUnicode(unicodeOhm),
  SymbolParts.oilBarrel: 'bbl',
  SymbolParts.ounce: 'oz',
  SymbolParts.parsec: 'pc',
  SymbolParts.partPerTenThousand: stringFromUnicode(unicodePartPerTenThousand),
  SymbolParts.partPerThousand: stringFromUnicode(unicodePartPerThousand),
  ...
  SymbolParts.pico: 'p',
  SymbolParts.pint: 'pt',
  SymbolParts.planck: '${stringFromUnicode(unicodePlanck)}p',
  ...
  SymbolParts.superscriptTwo: stringFromUnicode(unicodeSuperscriptTwo),
  SymbolParts.superscriptZero: stringFromUnicode(unicodeSuperscriptZero),
  SymbolParts.tablespoon: 'tbsp',
  SymbolParts.tau: stringFromUnicode(unicodeTau),
  SymbolParts.teaspoon: 'tsp',
  SymbolParts.tera: 'T',
  SymbolParts.tesla: 'T',
  SymbolParts.therm: 'thm',

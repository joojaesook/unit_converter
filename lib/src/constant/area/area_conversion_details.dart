...
Map<AreaUnits, double> areaConversionDetails = {
  ...
  AreaUnits.squareMile:
      pow(getConversionFactor(ConversionType.length, LengthUnits.mile), 2),
  ...
  AreaUnits.squarePerch:
      pow(getConversionFactor(ConversionType.length, LengthUnits.rod), 2),
  ...
  AreaUnits.squareYard:
      pow(getConversionFactor(ConversionType.length, LengthUnits.yard), 2),
